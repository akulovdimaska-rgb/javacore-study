...
public class A10_Tree2 {
    ...
    // подход через Стек. Здесь обход происходит в глубину - по левой стороне, а затем по правой, если слева нет ветвей
    ...
    // поиск суммы с помощью Очереди. Здесь порядок обхода в ширину
