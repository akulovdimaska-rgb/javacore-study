package Algorithms.A21_Prefix_tree;

// Префиксное дерево - это ассоциативный массив,где ключами являются строки, а данные могут быть какие угодно
// преимущество - хранятся префиксы без повторений
// Символы находятся на ребрах между узлами и указывают путь, но при практическом использовании лучше использовать
// тот вариант, где символы хранятся внутри узлов

// Если использовать как Set - хранилище для строк, а не как Map, то это более экономно
